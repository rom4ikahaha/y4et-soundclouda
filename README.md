# y4et-soundclouda
Учёт прослушиваний SoundCloud-реперов cтрахов роман 25-ивт-2-1
...
•	Предметная область : Показать на практическом примере, как спроектировать ИС: определить предметную область, роли и функции, а затем описать процессы в виде Use Case и блок схем, плюс наметить структуру БД и архитектуру .
В работе спроектирована учебная система учёта метрик прослушиваний треков рэп исполнителей на SoundCloud: сформулированы цели, роли, функции, построены схемы процессов, предложена ER модель и план реализации прототипа.
